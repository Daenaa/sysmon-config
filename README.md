 ...
 * Significant: 
This configuration contains the protection channel  which is about "FileBlockExecutable" and is generated when Sysmon detects and blocks the creation of executable files. Event ID= 27.
