...
*Significant: This configuration contains the protection channel  which is about "FileBlockExecutable" and is generated when Sysmon detects and blocks the creation of executable files. Event ID= 27.[ https://medium.com/@olafhartong/sysmon-14-0-fileblockexecutable-13d7ba3dff3e ]
